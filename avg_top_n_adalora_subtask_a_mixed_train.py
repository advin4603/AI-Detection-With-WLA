...
args = TrainingArguments(learning_rate=learning_rate, per_device_train_batch_size=per_device_train_batch_size, weight_decay=weight_decay, metric_for_best_model="eval_accuracy", greater_is_better=True, output_dir="/scratch/ayan.datta/avg_top_n_subtask_a_mixed", evaluation_strategy="steps",
...
trainer.save_model(output_dir="best_subtask_a_mixed_trained")
